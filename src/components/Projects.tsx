...
const projects = [
    {
        ...
        description: "Production-ready e-commerce with auth, cart, orders & admin dashboard.",
        longDescription: "Engineered a production-ready e-commerce platform supporting JWT-based authentication with bcrypt hashing, cart management, order processing, and a full admin dashboard. Integrated Razorpay payment gateway and Multer for secure image uploads. Designed MongoDB schemas for users, products, orders, and admin roles using Mongoose with robust security via input validation, session handling, and environment-based configuration.",
        techStack: ["Node.js", "Express", "MongoDB", "EJS", "Razorpay", "JWT", "Multer"],
        repo: "https://github.com/ANTHELIS/BAG_SHOP-_-_-Backend_Project",
        demo: "https://baggy.onrender.com/",
    ...
    {
        id: "multilingual-mandi",
        title: "SpeakHarvest",
        category: "AI • Marketplace",
        description: "AI-powered agricultural marketplace with real-time multilingual chat.",
        longDescription: "Developed a full-stack agricultural marketplace connecting farmers and buyers with real-time multilingual chat translation powered by Google Gemini 2.0 Flash. Features AI-driven voice assistance, structured market insights, and automated translation. Built secure REST APIs with authentication, rate limiting, MongoDB sanitization, and Helmet security hardening. Implemented voice-enabled inventory management for hands-free listing creation.",
        techStack: ["React", "Node.js", "Express", "MongoDB", "Google Gemini API", "Vite"],
        repo: "https://github.com/ANTHELIS/Bol-Mandi",
        demo: "https://speak-harvest.vercel.app/",
        color: "from-green-600/20 to-emerald-500/20",
        hoverColor: "group-hover:from-green-600/40 group-hover:to-emerald-500/40",
        span: "md:col-span-1 md:row-span-2",
        mediaType: "image",
        mediaUrl: "https://images.pexels.com/photos/974314/pexels-photo-974314.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
            ...
            <div className="max-w-7xl mx-auto relative">
                ...
                >
                    ...
                    <p className="text-gray-400 text-lg max-w-2xl leading-relaxed">
                        A curated selection of projects and achievements demonstrating full-stack capabilities,
                        AI integration, security expertise, and published research.
                    </p>
                </motion.div>

                {/* Bento Grid Layout */}
                <motion.div layout className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[minmax(280px,auto)]">
                ...
                <motion.div layout className="flex justify-center mt-12">
                    {hasMore ? (
                        ...
                        <motion.button
                            whileHover={{ scale: 1.05 }}
                            whileTap={{ scale: 0.95 }}
                            onClick={() => { document.getElementById('projects')?.scrollIntoView({ behavior: 'smooth' }); setVisibleCount(INITIAL_VISIBLE_COUNT); }}
                            className="px-8 py-3 rounded-full bg-white/5 border border-white/10 text-white font-medium hover:bg-white/10 transition-colors backdrop-blur-md flex items-center gap-2 group"
                        >
                            Show Less
                            <svg className="w-4 h-4 group-hover:-translate-y-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                >
                                    ...
                                    <div className="flex flex-col md:flex-row h-full">
                                        ...
                                        <div className="w-full md:w-3/5 p-8 md:p-12 bg-[#121212]">
                                            ...
                                            >
                                                <h4 className="text-sm font-bold text-gray-500 uppercase tracking-wider mb-4">About this project</h4>
                                                <p className="text-gray-300 leading-relaxed mb-8 text-lg">
                                                    {selectedProject.longDescription}
                                                </p>

                                                <div className="mb-10">
                                                    <h4 className="text-sm font-bold text-gray-500 uppercase tracking-wider mb-4">Technologies & Skills</h4>
                                                ...
                                                <div className="flex gap-4 pt-4 border-t border-white/10">
                                                    ...
                                                    >
                                                        {/* Icon: GitHub or Certificate */}
                                                        {(selectedProject as any).repoLabel ? (
                                                        ...
                                                        {(selectedProject as any).repoLabel ?? "View on GitHub"}
                                                    </a>
                                                    {!(selectedProject as any).hideDemoBtn && (
                                                        <a
                                                        ...
                                                        >
                                                            {(selectedProject as any).demoLabel ?? "Live Demo"}
