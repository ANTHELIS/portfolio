        ...
        <div className="absolute inset-0 pointer-events-none z-10 flex flex-col justify-center text-white mix-blend-difference">
            ...
            >
                <div className="max-w-2xl">
                    <h2 className="text-5xl md:text-7xl font-bold leading-tight">Building secure <br /><span className="text-blue-500">full-stack</span> platforms.</h2>
                </div>
            </motion.div>
            ...
            >
                <div className="max-w-2xl">
                    <h2 className="text-5xl md:text-7xl font-bold leading-tight">Expertise in React, <br /><span className="text-purple-500">Node.js</span> & MongoDB.</h2>
                </div>
            </motion.div>
        </div>
    );
